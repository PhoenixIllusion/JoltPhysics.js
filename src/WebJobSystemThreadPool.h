...
class JPH_EXPORT WebJobSystemThreadPool final : public WebJobSystemWithBarrier
{
public:
	...
	/// @see JobSystemThreadPool::Init
							WebJobSystemThreadPool(uint inMaxJobs, uint inMaxBarriers, int inNumThreads = -1);
							WebJobSystemThreadPool() = default;
	virtual					~WebJobSystemThreadPool() override;
