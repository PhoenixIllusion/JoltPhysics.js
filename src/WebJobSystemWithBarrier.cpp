...
#include "WebJobSystemWithBarrier.h"
...
void WebJobSystemWithBarrier::BarrierImpl::AddJob(const JobHandle &inJob)
{
...
void WebJobSystemWithBarrier::BarrierImpl::AddJobs(const JobHandle *inHandles, uint inNumHandles)
{
	JPH_PROFILE_FUNCTION();
...
void WebJobSystemWithBarrier::BarrierImpl::OnJobFinished(Job *inJob)
{
	JPH_PROFILE_FUNCTION();
...
void WebJobSystemWithBarrier::BarrierImpl::Wait()
{
...
void WebJobSystemWithBarrier::Init(uint inMaxBarriers)
{
...
WebJobSystemWithBarrier::WebJobSystemWithBarrier(uint inMaxBarriers)
{
	Init(inMaxBarriers);
}

WebJobSystemWithBarrier::~WebJobSystemWithBarrier()
{
...
JobSystem::Barrier *WebJobSystemWithBarrier::CreateBarrier()
{
	JPH_PROFILE_FUNCTION();
...
void WebJobSystemWithBarrier::DestroyBarrier(Barrier *inBarrier)
{
	JPH_PROFILE_FUNCTION();
...
void WebJobSystemWithBarrier::WaitForJobs(Barrier *inBarrier)
{
	JPH_PROFILE_FUNCTION();
