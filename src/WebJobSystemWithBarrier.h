...
class JPH_EXPORT WebJobSystemWithBarrier : public JobSystem
{
public:
	...
	explicit				WebJobSystemWithBarrier(uint inMaxBarriers);
							WebJobSystemWithBarrier() = default;
	virtual					~WebJobSystemWithBarrier() override;
...
private:
	...
	protected:
		...
		WebSemaphore			mSemaphore;										///< Semaphore used by finishing jobs to signal the barrier that they're done
	};
